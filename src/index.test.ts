...
describe('RtlLanguageDetector', () => {
  ...
  describe('detectLocale', () => {
    ...
    test('should use navigator.languages[0] if available', () => {
      Object.defineProperty(global, 'navigator', {
        value: { languages: ['fr-FR', 'en-US'] },
        configurable: true,
      });
      expect(RtlLanguageDetector.detectLocale()).toBe('fr-FR');
    });

    test('should use navigator.browserLanguage if available', () => {
      Object.defineProperty(global, 'navigator', {
        value: { browserLanguage: 'fa-IR' },
        configurable: true,
      });
      expect(RtlLanguageDetector.detectLocale()).toBe('fa-IR');
    });

    test('should use navigator.systemLanguage if available', () => {
      Object.defineProperty(global, 'navigator', {
        value: { systemLanguage: 'ur-PK' },
        configurable: true,
      });
      expect(RtlLanguageDetector.detectLocale()).toBe('ur-PK');
    });

    test('should use navigator.language if languages is not available', () => {
      Object.defineProperty(global, 'navigator', {
        value: { language: 'de-DE' },
        configurable: true,
      });
      expect(RtlLanguageDetector.detectLocale()).toBe('de-DE');
    });

    test('should use legacy IE properties if available', () => {
      Object.defineProperty(global, 'navigator', {
        value: { userLanguage: 'ar-EG' },
        configurable: true,
      });
      expect(RtlLanguageDetector.detectLocale()).toBe('ar-EG');
    });

    test('should use Intl API if navigator is not available', () => {
      ...
      global.Intl = {
        DateTimeFormat: (): { resolvedOptions: () => { locale: string } } => ({
          resolvedOptions: (): { locale: string } => ({ locale: 'es-ES' }),
        }),
      } as unknown as typeof Intl;
      expect(RtlLanguageDetector.detectLocale()).toBe('es-ES');
      global.Intl = origIntl;
    });

    test('should use <html lang> if nothing else is available', () => {
      Object.defineProperty(global, 'navigator', { value: undefined, configurable: true });
      Object.defineProperty(global, 'Intl', { value: undefined, configurable: true });
      Object.defineProperty(global, 'document', {
        value: { documentElement: { lang: 'it-IT' } },
        configurable: true,
      });
      expect(RtlLanguageDetector.detectLocale()).toBe('it-IT');
    });

    test('should return empty string if nothing is available', () => {
      Object.defineProperty(global, 'navigator', { value: undefined, configurable: true });
      Object.defineProperty(global, 'Intl', { value: undefined, configurable: true });
      Object.defineProperty(global, 'document', {
      ...
      expect(RtlLanguageDetector.detectLocale()).toBe('');
    });
  });
  ...
  describe('detectTextDirection', () => {
    ...
    test('should return ltr if <html dir="ltr">', () => {
      Object.defineProperty(global, 'document', {
        value: {
          documentElement: {
            getAttribute: (k: string) => (k === 'dir' ? 'ltr' : undefined),
          },
        },
        configurable: true,
      });
      expect(RtlLanguageDetector.detectTextDirection()).toBe('ltr');
    });

    test('should infer direction from detected locale', () => {
      Object.defineProperty(global, 'navigator', {
        value: { languages: ['ar'] },
        configurable: true,
      });
      ...
      expect(RtlLanguageDetector.detectTextDirection()).toBe('rtl');
      Object.defineProperty(global, 'navigator', {
        value: { languages: ['en'] },
        configurable: true,
      });
    ...
    test('should default to ltr if nothing is detected', () => {
      Object.defineProperty(global, 'navigator', { value: undefined, configurable: true });
      Object.defineProperty(global, 'Intl', { value: undefined, configurable: true });
      Object.defineProperty(global, 'document', {
        value: {
